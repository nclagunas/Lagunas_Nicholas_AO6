...
sum_of_digits = function(digit = NA){
  ...
  rest_of = substr(digit_str,2,nchar(digit_str))
  
  
  return(as.numeric(rest_of))
  #return(as.numeric(first_digit) + sum_of_digits(as.numeric(rest_of)))
