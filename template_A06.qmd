...
for(i in 3:length(data_CO)){
  
  
  
  co_medians = append(co_medians,median(data_CO[[i]]))
}

names_months = names(data_CO)[3:length(data_CO)]

co_medians = set_names(co_medians,names_months)

#print(co_medians)

max_med = which.max(co_medians)
min_med = which.min(co_medians)

#paste0("The maximum median annual temperature of ",names(co_medians[max_med]))
